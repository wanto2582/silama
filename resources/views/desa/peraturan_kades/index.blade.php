<x-app-layout>
    <x-slot name="title">Buku Data Peraturan Kepala Desa</x-slot>
    <div class="card-box mb-30">
        <div class="pd-20">
            <h4 class="text-blue h4">Buku Data Peraturan Kepala Desa</h4>
        </div>
        <div class="card-body">
            <div class="h5 pd-20 mb-0">
                <x-button.primary-button class="btn btn-primary"><a href="{{ route('desa.aparatur-pemdes.create') }}" style="text-decoration: none; color:white;"> Tambah Data Baru </a></x-button.primary-button>
            </div>
                ...
                <table id="contentTable" class="display table table-striped table-hover" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 30%;">NOMOR DAN TANGGAL KEPUTUSAN KEPALA DESA</th>
                            <th style="width: 10%;">TENTANG</th>
                            <th style="width: 20%;">URAIAN SINGKAT</th>
                            <th style="width: 10%;">NOMOR DAN TANGGAL DILAPORKAN</th>
        ...
        function initDataTable() {
            ...
            $(document).ready(function() {
                ...
                var table = $('#contentTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{route('desa.surat.aparatur_pemdes_table')}}",
                        type: 'GET'
                    },
                    columns: [{
                            data: 'DT_RowIndex',
