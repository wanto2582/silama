<x-app-layout>
    ...
    <div class="pd-20 card-box mb-10 shadow-lg rounded-lg border-primary">
                ...
                <div class="col-md-12">
                    <select name="pilih_surat" id="pilih_surat" class="form-control custom-select-lg shadow-sm rounded" style="width: 100%; height: 45px; background: #ffe0b2; " onchange="showCard(this.value)">
                        ...
                        <optgroup label="SURAT PERNYATAAN">
                            ...
                            <option value="sksp">Surat Kesepakatan</option>
                        </optgroup>
        ...
        <x-form-surat.sksp id="sksp" :detailSurat="$detailSurat" :nextId="$nextId" style=" display: none;" />
        {{-- SURAT PENGANTAR --}}
            ...
            <div class="d-flex flex-wrap justify-content-start align-items-stretch custom-card-row">
                    ...
                    <div class="card-box height-100-p widget-style1 py-2 px-1" style="background: #bbdefb;">
                        <div class="d-flex flex-column align-items-center" style="gap: 2px;">
                            <div class="d-flex flex-row flex-md-column align-items-center mb-1" style="gap: 5px;">
                                <i class="bi bi-file-earmark-ruled" style="font-size: 1.5rem; color: #1976d2;"></i>
                                <div class="h5 mb-0" style="font-size: 1.1rem;">Surat</div>
                            </div>
                ...
                <div class="custom-card-col mb-10">
                    ...
                    <div class="card-box height-100-p widget-style1 py-2 px-1" style="background: #c8e6c9;">
                        <div class="d-flex flex-column align-items-center" style="gap: 2px;">
                            <div class="d-flex flex-row flex-md-column align-items-center mb-1" style="gap: 5px;">
                                <i class="bi bi-file-earmark-ruled" style="font-size: 1.5rem; color: #388e3c;"></i>
                                <div class="h5 mb-0" style="font-size: 1.1rem;">Surat</div>
                            </div>
                ...
                <div class="custom-card-col mb-10">
                    ...
                    <div class="card-box height-100-p widget-style1 py-2 px-1" style="background: #ffe0b2;">
                        <div class="d-flex flex-column align-items-center" style="gap: 2px;">
                            <div class="d-flex flex-row flex-md-column align-items-center mb-1" style="gap: 5px;">
                                <i class="bi bi-file-earmark-ruled" style="font-size: 1.5rem; color: #f57c00;"></i>
                                <div class="h5 mb-0" style="font-size: 1.1rem;">Surat</div>
                            </div>
                ...
                <div class="custom-card-col mb-10">
                    ...
                    <div class="card-box height-100-p widget-style1 py-2 px-1" style="background: #ffcdd2;">
                        <div class="d-flex flex-column align-items-center" style="gap: 2px;">
                            <div class="d-flex flex-row flex-md-column align-items-center mb-1" style="gap: 5px;">
                                <i class="bi bi-file-earmark-ruled" style="font-size: 1.5rem; color: #d32f2f;"></i>
                                <div class="h5 mb-0" style="font-size: 1.1rem;">Surat</div>
                            </div>
                ...
                <div class="custom-card-col mb-10">
                    ...
                    <div class="card-box height-100-p widget-style1 py-2 px-1" style="background: #e0f2f7;">
                        <div class="d-flex flex-column align-items-center" style="gap: 2px;">
                            <div class="d-flex flex-row flex-md-column align-items-center mb-1" style="gap: 5px;">
                                <i class="bi bi-file-earmark-ruled" style="font-size: 1.5rem; color: #0288d1;"></i>
                                <div class="h5 mb-0" style="font-size: 1.1rem;">Surat</div>
                            </div>
                ...
                <div class="custom-card-col mb-10">
                    ...
                    <div class="card-box height-100-p widget-style1 py-2 px-1" style="background: #e1bee7;">
                        <div class="d-flex flex-column align-items-center" style="gap: 2px;">
                            <div class="d-flex flex-row flex-md-column align-items-center mb-1" style="gap: 5px;">
                                <i class="bi bi-file-earmark-ruled" style="font-size: 1.5rem; color: #8e24aa;"></i>
                                <div class="h5 mb-0" style="font-size: 1.1rem;">Surat</div>
                            </div>
                            <div class="weight-600 font-12 mt-0" style="font-size: 0.8rem;">.......</div>
                        </div>
                ...
                <div class="custom-card-col mb-10">
                    ...
                    <div class="card-box height-100-p widget-style1 py-2 px-1" style="background: #fff9c4;">
                        <div class="d-flex flex-column align-items-center" style="gap: 2px;">
                            <div class="d-flex flex-row flex-md-column align-items-center mb-1" style="gap: 5px;">
                                <i class="bi bi-file-earmark-ruled" style="font-size: 1.5rem; color: #fbc02d;"></i>
                                <div class="h5 mb-0" style="font-size: 1.1rem;">Surat</div>
                            </div>
                            <div class="weight-600 font-12 mt-0" style="font-size: 0.8rem;">.......</div>
                        </div>
                ...
                <div class="custom-card-col mb-10">
                    ...
                    <div class="card-box height-100-p widget-style1 py-2 px-1" style="background: #d1c4e9;">
                        <div class="d-flex flex-column align-items-center" style="gap: 2px;">
                            <div class="d-flex flex-row flex-md-column align-items-center mb-1" style="gap: 5px;">
                                <i class="bi bi-file-earmark-ruled" style="font-size: 1.5rem; color: #5e35b1;"></i>
                                <div class="h5 mb-0" style="font-size: 1.1rem;">Surat</div>
                            </div>
                            <div class="weight-600 font-12 mt-0" style="font-size: 0.8rem;">.......</div>
                        </div>
...
<script>
    ...
    function showCard(selectedValue) {
        ...
        const allCardContentIds = [
            ...
            "sptn", "sksp", "spb", // Surat Pernyataan (perhatikan 'spb' duplikat, pastikan ini sengaja)
...
{{-- <script>
    function showCard(selectedValue) {
        ...
        document.getElementById("sksp").style.display = "none";
        document.getElementById("spb").style.display = "none";
        ...
        } else if (selectedValue === "sksp") {
            document.getElementById("sksp").style.display = "block";
...
<style>
    ...
    .custom-card-row {
        margin-left: -5px;
        /* Mengurangi padding default dari .row atau gap */
        margin-right: -5px;
        /* Mengurangi padding default dari .row atau gap */
    }
    ...
    .custom-card-col {
        flex: 0 0 auto;
        /* Hindari pertumbuhan atau penyusutan */
        width: 12.5%;
        /* 100% / 8 = 12.5% */
        padding-left: 5px;
        /* Sesuaikan dengan margin-left/right di parent */
        padding-right: 5px;
        /* Sesuaikan dengan margin-left/right di parent */
    ...
    @media (max-width: 1199.98px) {
        ...
        /* Untuk layar laptop dan tablet besar (lg) */
        .custom-card-col {
            width: 25%;
            /* 4 item per baris */
        }
    ...
    @media (max-width: 575.98px) {
        ...
        /* Untuk mobile kecil (xs) */
        .custom-card-col {
            width: 50%;
            /* INI YANG DIUBAH: 2 item per baris untuk mobile */
        }
    }
</style>