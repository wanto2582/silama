<x-app-layout>
    <x-slot name="title">Buku Data Peraturan Bersama Kepala Desa</x-slot>
    <div class="card-box mb-30">
        <div class="pd-20">
            <h4 class="text-blue h4">Buku Data Peraturan Bersama Kepala Desa</h4>
        </div>
        <div class="card-body">
            <div class="h5 pd-20 mb-0">
                <x-button.primary-button class="btn btn-primary"><a href="{{ route('desa.peraturan-berkades.create') }}" style="text-decoration: none; color:white;"> Tambah Data Baru </a></x-button.primary-button>
            </div>
        ...
        function initDataTable() {
            ...
            $(document).ready(function() {
                ...
                var table = $('#contentTable').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{route('desa.surat.peraturan_berkades_table')}}",
                        type: 'GET'
                    },
                    columns: [{
                            data: 'DT_RowIndex',
                ...
                $(document).on('click', '.delete-btn', function(e) {
                    ...
                    const deleteUrl = '{{ route("desa.peraturan-berkades.destroy", ":id") }}'.replace(':id', id);
