                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <x-text-input id="nama" name="nama" type="text" class="form-control" value="{{old('nama', $peraturanBerkades->nama ?? '')}}" required autofocus autocomplete="nama" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <x-text-input id="perihal" name="perihal" type="text" class="form-control" value="{{old('perihal', $peraturanBerkades->perihal ?? '')}}" required autofocus autocomplete="perihal" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <x-text-input id="nama_kades" name="nama_kades" type="text" class="form-control" value="{{old('nama_kades', $peraturanBerkades->nama_kades ?? '')}}" required autofocus autocomplete="nama_kades" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <x-text-input name="tahun" type="text" class="form-control" value="{{old('tahun', $peraturanBerkades->tahun ?? '')}}" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    @if(isset($peraturanBerkades) && $peraturanBerkades->file_pdf)
                                    <div class="mt-2">
                                        <small class="text-info">
                                            <i class="fa fa-file-pdf-o"></i>
                                            File saat ini: <a href="{{ asset('storage/' . $peraturanBerkades->file) }}" target="_blank">{{ basename($peraturanBerkades->file) }}</a>
                                        </small>
                                    </div>
                                    @endif
                            ...
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" class="form-control" rows="3" placeholder="Keterangan tambahan (opsional)">{{old('keterangan', $peraturanBerkades->keterangan ?? '')}}</textarea>
