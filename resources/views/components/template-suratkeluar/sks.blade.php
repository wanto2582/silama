...
<body>
    ...
    <div class="container">
        ...
        <p style="padding: 0 50px 0 50px; text-align: justify;">
            Yang bersangkutan tersebut diatas benar, adalah warga Desa Manyampa dan sa'at ini dalam keadaan sakit <b>{{$listkeluar->paragraf_1 ?? ''}}</b>.
            <br>
        </p>
        <p style="padding: 0 50px 0 50px; margin-top:30px">
            Surat Keterangan ini dibuat untuk keperluan : {{$listkeluar->tujuan ?? ''}}.
        </p>
        <p style="padding: 0 50px 0 50px; text-align: justify;">
