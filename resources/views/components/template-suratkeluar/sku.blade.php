...
<body>
    ...
    <div class="container">
        ...
        <x-nomor-suratkeluar type="sku" :index="$indeks[$ps->id]+1" />
        ...
        <table style="padding: 0 90px 0 80px; width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: left; padding-left: 10px;">: {{$listkeluar->nama_instansi ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left; width: 30%;">Mulai usaha sejak</td>
                <td style="text-align: left; padding-left: 10px;">: {{\Carbon\Carbon::parse($listkeluar->mulai_usaha)->isoFormat('D MMMM YYYY') ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left;">Alamat Usaha</td>
                <td style="text-align: left; padding-left: 10px;">: {{$listkeluar->alamat_usaha ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left;">Tujuan</td>
                <td style="text-align: left; padding-left: 10px;">: {{$listkeluar->tujuan ?? ''}}</td>
            </tr>
        </table>
        <p style="padding: 0 50px 0 50px; text-align: justify;">
