...
<body>
        ...
        <div class="ttd">
            ...
            <div class="ttd-kanan" style="text-align: center">
                ...
                <div class="qr-container">
                    ...
                    <img class="object-a" style="margin-top: -25px;" src="data:image/png;base64, {!! base64_encode(QrCode::size(80)->generate('https://silama.apk62.com/cekkeluar/suratkeluar/'.$listkeluar->id)) !!} ">
                </div>
                @endif
                <br>
                <br>
    ...
    <div class="footer">
        ...
        <div class="footer-image">
            <img src="data:image/png;base64, {!! base64_encode(QrCode::size(40)->generate('https://silama.apk62.com/cekkeluar/suratkeluar/'.$listkeluar->id)) !!} " style="align: right;" alt="Kunci Elektronik" class="footer-lock-icon">
