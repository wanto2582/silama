...
<body>
    ...
    <div class="container">
        ...
        <x-nomor-suratkeluar type="sktm" :index="$indeks[$ps->id]+1" />
        ...
        <p style="padding: 0 50px 0 50px; text-align: justify;">
            Yang tersebut namanya diatas benar adalah warga Desa Manyampa, tergolong dalam  kategori keluarga prasejahtera ( Keluarga Berpenghasilan Rendah).
            <br>
            Surat Keterangan ini diberikan untuk keperluan : {{$listkeluar->tujuan ?? ''}}.
        </p>
        <p style="padding: 0 50px 0 50px; text-align: justify;">
