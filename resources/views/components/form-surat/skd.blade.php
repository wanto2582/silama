<div {{ $attributes }} style="display: none;" class="pd-20 card-box mb-30">
    ...
    <div class="split-container">
        ...
        <div class="split-left">
            <form id="skdForm" method="POST" action="{{ route('desa.surat.store') }}" enctype="multipart/form-data" novalidate>
                @csrf
        ...
        <div class="split-right">
            ...
            <div class="pdf-viewer">
                ...
                <embed src="{{ route('public.pdf.show', ['filename' => 'domisili.pdf']) }}" type="application/pdf" width="100%" height="800px" />
