                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <x-input-label>Nama Surat : </x-input-label>
                            <x-text-input name="nama_surat" type="text" class="form-control" />
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="paragraf_1" type="textarea" class="ckeditor form-control" >
                            </textarea>
