...
<body>
    ...
    <div class="container">
        ...
        <x-nomor-surat type="skk" :index="$indeks[$ps->id]+1" />
        ...
        <table style="padding: 0 90px 0 80px; width: 100%; border-collapse: collapse;">
            ...
            <tr>
                ...
                <td style="text-align: left; padding-left: 10px;">: {{$list->bin ?? ''}}</td>
            </tr>
            <tr>
        ...
        <table style="padding: 0 90px 0 80px; width: 100%; border-collapse: collapse;">
            <tr>
                ...
                <td style="text-align: left; padding-left: 10px;">: {{\Carbon\Carbon::parse($list->tanggal_meninggal)->isoFormat('D MMMM YYYY') ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left; width: 30%;">Jam</td>
                <td style="text-align: left; padding-left: 10px;">: {{$list->jam_meninggal ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left;">Tempat Meninggal</td>
                <td style="text-align: left; padding-left: 10px;">: {{$list->tempat_meninggal ?? ''}}</td>
            </tr>
            <tr>
                <td style="text-align: left;">Sebab Kematian</td>
                <td style="text-align: left; padding-left: 10px;">: {{$list->sebab_meninggal ?? ''}}</td>
            </tr>
        </table>
        <p style="padding: 0 50px 0 50px">
