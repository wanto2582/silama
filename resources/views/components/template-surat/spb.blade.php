...
<head>
    ...
    <title>SURAT PERNYATAAN 2</title>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <hr class="line" />
    <div class="container">
        <h3 class="judul">SURAT PERNYATAAN 2</h3>
        <!-- <p style="text-align: center; margin-top: 0; padding: 0; margin-bottom: 20px;">Nomor. 470/{{$indeks[$ps->id]+1}}/424.311.2.10/2024</p> -->
        <x-nomor-surat type="spb" :index="$indeks[$ps->id]+1" />
        <p style="padding: 0 50px 0 50px; text-align: justify;">Yang bertanda tangan dibawah ini Kepala Desa Manyampa, Kecamatan Ujung Loe, Kabupaten Bulukumba menerangkan dengan sesungguhnya bahwa :</p>
        ...
        <p style="padding: 0 50px 0 50px; text-align: justify;">
            Yang bersangkutan tersebut diatas, benar berdomisili di {{'RT.'. $list->rt .', RW.'. $list->rw .', Dusun '. $list->dusun ?? ''}}.
            <br>
            Surat Keterangan ini dibuat untuk keperluan {{$list->tujuan ?? ''}}.
        </p>
        <p style="padding: 0 50px 0 50px; text-align: justify;">
