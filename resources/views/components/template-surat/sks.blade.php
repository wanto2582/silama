...
<body>
    ...
    <div class="container">
        ...
        <x-nomor-surat type="sks" :index="$indeks[$ps->id]+1" />
        ...
        <p style="padding: 0 50px 0 50px; text-align: justify;">
            Yang bersangkutan tersebut diatas benar, adalah warga Desa Manyampa dan sa'at ini dalam keadaan sakit <b>{{$list->paragraf_1 ?? ''}}</b>.
            <br>
        </p>
