...
<body>
    ...
    <div class="container">
        ...
        {{-- <x-nomor-surat type="sptn" :index="$indeks[$ps->id]+1" /> --}}
       ...
       <div class="ttdkanan" style="padding: 0 50px 0 50px; margin-top: 0px;
        ...
        <div class="ttd" style="text-align: center"> 
            ...
            <div class="ttd-kiri" style="text-align: center ">
                ...
                <br>
                <x-nomor-surat type="sptn" :index="$indeks[$ps->id]+1" />
                <p style="margin-bottom: 5px; margin-top: -20px;">Manyampa, {{\Carbon\Carbon::parse($list->created_at)->isoFormat('D MMMM YYYY') ?? ''}}
        ...
        <div class="ttd">
            ...
            <div class="ttd-kanan" style="text-align: center">
                <br>
                <br>
                <p style="margin-bottom: 5px;">Yang Menyatakan
                    <br style="margin-bottom: 5px;"><b></b>
                </p>
                <br>
                <br>
                <br>
                @if ($ps->status == "Selesai")
                <div class="qr-container">
                    <img style="width: 20px; margin-top: -25px;" src="" class="lego" alt="">
                    <img class="object-a" style="margin-top: -25px;" src="" >
                </div>
                @endif
                <br>
                <br>
                <p style="margin-top: -25px;"><u><b>...................</b></u></p>
            </div>
        </div>
